 ...
 */
public class ListUpcomingEventActivity extends AppCompatActivity {

    private static final String TAG = ListUpcomingEventActivity.class.getSimpleName();
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Daftar Jadwal Akan Datang");
    ...
    void getUpcomingEventData() {
        ...
        call = service.listEventConfirmed();
